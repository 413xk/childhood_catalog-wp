...
<!-- single.php по иерархии вордпресса находится почти в самом конце очереди для подключения шаблонов. На wp-kama есть статья -->
<!-- включается, когда тип поста: post и категория edu_toys -->
<!-- включить можно на странице записи, шаблон по умолчанию-->
